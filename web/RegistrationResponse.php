        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST')
         {
            ...
            $RegValidation = new RegistrationValidationController();

            //call the register method and get the results
            $result = $RegValidation->register($username, $email, $password, $role);
...
$errors = implode('<br>', $errors);
        ...
        $form = FormGenerator::generateForm('Registration.php','post',$fields);
